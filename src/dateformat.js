...
const replacements = [
  ...
  { regex: /mmmm/g, replace: date => months[date.getMonth()].substring(0, 3).toUpperCase() },
  { regex: /mm/g, replace: date => zeroPad(date.getMonth(), 2) },
  { regex: /m/g, replace: date => date.getMonth() },
  { regex: /yyyy/g, replace: date => date.getYear() },
  { regex: /yy/g, replace: date => date.getYear().toString().substring(2) },
  ...
  { regex: /ss/g, replace: date => zeroPad(date.getSeconds()) },
